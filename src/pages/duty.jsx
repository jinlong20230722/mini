      ...
      <div className="max-w-lg mx-auto p-4 space-y-4">
        ...
        animationDelay: '0.1s' }}>
          ...
          {expandedSections.ethics && <div className="p-4 space-y-4 transition-all duration-300 ease-in-out">
              {ethicsContent.items.map((item, index) => <div key={index} className="p-4 bg-[#F8FAFC] rounded-lg border-l-4 border-[#6366F1] transition-all duration-300 ease-in-out hover:shadow-md hover-lift">
                  <h3 className="font-semibold text-[#0F172A] mb-2 font-['Space_Grotesk']">{item.title}</h3>
                  <p className="text-[#475569] text-sm leading-relaxed font-['JetBrains_Mono']">{item.content}</p>
                </div>)}
            </div>}
        </div>
        ...
        animationDelay: '0.8s' }}>
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              <h3 className="font-semibold text-[#0F172A] mb-1 font-['Space_Grotesk']">温馨提示</h3>
              <p className="text-sm text-[#475569] leading-relaxed font-['JetBrains_Mono']">
